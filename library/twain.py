...
# -*- coding: UTF-8 -*-
"""
感谢misha大佬开源的此扫描仪驱动程序，但本人并未找到相关开源协议和源地址，故而只能在readme中进行感谢
...
class SourceManager(object):
    ...
    def __init__(self,
        ...
        elif hasattr(parent_window, 'window') and hasattr(parent_window.main_window, 'handle'):
            # gtk window
            self._hwnd = parent_window.main_window.handle
        else:
